...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CompoUseInfo',
            fields=[
                ('wsid', models.OneToOneField(db_column='wsid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='purchase.Worksheet')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('wid', models.OneToOneField(db_column='wid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='purchase.Worker')),
                ('wname', models.CharField(max_length=10)),
                ('dept', models.CharField(max_length=20)),
                ('postion', models.CharField(max_length=20)),
        ...
        migrations.CreateModel(
            name='CoPurchase',
            fields=[
                ('purchaseid', models.OneToOneField(db_column='purchaseid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='purchase.Purchase')),
                ('purchasenum', models.IntegerField(blank=True, null=True)),
                ('purchasestate', models.CharField(blank=True, max_length=20, null=True)),
                ('warehouse_time', models.DateTimeField(blank=True, null=True)),
                ('psumprice', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True)),
                ('ptime', models.DateTimeField(blank=True, null=True)),
                ('coid', models.ForeignKey(blank=True, db_column='pur_coid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='purchase.Components')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('psumprice', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True)),
                ('ptime', models.DateTimeField(blank=True, null=True)),
                ('id', models.ForeignKey(blank=True, db_column='id', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='Pur_id', to='purchase.CarInfo')),
            ],
            options={
