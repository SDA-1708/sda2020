...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CarPurchase',
            fields=[
                ('purchaseid', models.OneToOneField(db_column='purchaseid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='HumanResources.Purchase')),
                ('purchasenum', models.IntegerField(blank=True, null=True)),
                ('purchasestate', models.CharField(blank=True, max_length=20, null=True)),
                ('psumprice', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True)),
                ('ptime', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            name='CompoUseInfo',
            fields=[
                ('wsid', models.OneToOneField(db_column='wsid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='HumanResources.Worksheet')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('wid', models.OneToOneField(db_column='wid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='HumanResources.Worker')),
                ('wname', models.CharField(max_length=10)),
                ('dept', models.CharField(max_length=20)),
